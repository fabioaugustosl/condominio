<html>
	...
	<body>
		...
		<p>Foi disponibilizada a ata da assembleia realizada dia ${data_assembleia} no site.</p>
		Acesse agora mesmo o site www.condominiosobcontrole.com.br e fique por dentro do que está acontecendo em seu condomínio.
		<br />
